...
const FormEditSuratMasuk = () => {
  const navigate = useNavigate();
  const { idSuratMasuk } = useParams()
  ...
  const getSuratMasukByID = async () => {
    try {
      const response = await ServiceSurat.getSuratMasukByID(idSuratMasuk);
      setTanggalTerima(formatDate(response.data.TANGGAL_TERIMA) )
  ...
  const validate = () => {
    ...
    if (!pengirim) newErrors.pengirim = "Pengirim wajib diisi";
      ...
      <div className="flex flex-col gap-3 px-5 my-2 border-lg shadow w-full py-3 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6">
          ...
          <div className="flex flex-col">
              <label className="mb-1 font-medium text-sm">Tanggal Terima</label>
            <input
              type="date"
              value={tanggalTerima}
          ...
          {/* Pengirim */}
          <div className="flex flex-col">
            <label className="mb-1 font-medium text-sm">Pengirim</label>
            <input
              type="text"
              value={pengirim}
...
export default FormEditSuratMasuk;
